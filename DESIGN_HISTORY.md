# Design history and earlier prototypes

Historical snapshots retain the assumptions and prices used at the time. Use the [project README](README.md) and latest corner-guide files for current specifications and costs.
...
**Current corner-magnet and paper-guide revision:** [rendered views](output/corner_guide_elbow/index.html), [Blender](output/corner_guide_elbow/Corner_Guide_Elbow.blend), and [assembly PDF](output/corner_guide_elbow/Corner_Guide_Elbow.pdf). Each top elbow now has three magnet seats: top, side and corner. A recessed L (0.8 mm wide, 0.4 mm deep) marks the exact paper corner and edge centerlines. The corner magnet remains behind a 0.4 mm skin, with a 10 mm rear access well. Both guy eyes and 33.5 mm PVC bores remain. [One-elbow A1 Mini PETG job](output/corner_guide_elbow/sliced/ONE_DUAL_GUY_ELBOW/ONE_DUAL_GUY_ELBOW_A1Mini_PETG.3mf): **103.06 g / about 4 hours**, no supports. Single: 76 magnet pairs; stacked: 120. Geometry, alignment probes and slicing pass; first-print checks remain. The earlier files are preserved.

**Previous two-magnet dual-guy elbow revision:** [visual views](output/dual_guy_gate/index.html), [Blender model](output/dual_guy_gate/Dual_Guy_Gate.blend), and [assembly/test PDF](output/dual_guy_gate/Dual_Guy_Assembly.pdf). A reinforced diagonal ear has two independent through-eyes for simultaneous front/rear guys; top and side magnet holders replace the corner holder. The ear extends about 28.6 mm outside the paper so neither line needs a paper cutout. All PVC bores remain **33.5 mm**; other production STLs are unchanged. [Print one revised elbow](output/dual_guy_gate/sliced/ONE_DUAL_GUY_ELBOW/ONE_DUAL_GUY_ELBOW_A1Mini_PETG.3mf): **102.57 g PETG / about 3 h 57 min**, support-free on the A1 Mini. Two per gate, adding 50.36 g / 1.81 hours and four individual magnets versus baseline. Single total: **2.324 kg / 94.4 hours**; stacked: **3.690 kg / 150.3 hours**. Digital geometry and routing checks pass; physical socket and guy-load tests remain. No new print was opened or submitted. The preceding design and workshop status were committed as **6a7fb47** before this revision.

**Committed tee baseline:** [tees, top guy elbows and the PVC measuring jig](output/tee_pvc_gate/index.html), [Blender model](output/tee_pvc_gate/Tee_PVC_Gate.blend), and [measuring/assembly PDF](output/tee_pvc_gate/Tee_Gate_and_Measuring_Guide.pdf). **The 33.5 mm sleeve fit was physically accepted on 2026-09-18; its STL is unchanged.** New tees replace eight crosses per single gate, and the two top elbows have integral guy eyes. Five gate types / 64 pieces single / 104 stacked. Single: **2.273 kg PETG / 92.6 hours**; stacked: **3.640 kg / 148.5 hours**. Net savings versus the preceding design: **255 g / 9.7 hours single**, **391 g / 14.9 hours stacked**. [Two-head measuring plate](output/tee_pvc_gate/sliced/MEASURING_KIT/MEASURING_KIT_A1Mini_PETG.3mf) uses existing PVC and a tape-calibrated spacing to mark the 389.6 and 1560.8 mm cuts; remove the marked pipe before using the Husky ratcheting cutter. [Print one tee](output/tee_pvc_gate/sliced/ONE_TEE/ONE_TEE_A1Mini_PETG.3mf) or [one top guy elbow](output/tee_pvc_gate/sliced/ONE_GUY_ELBOW/ONE_GUY_ELBOW_A1Mini_PETG.3mf). All supplied plates fit the A1 Mini and slice without supports. New fitting/tool performance and eye loads await physical tests.
