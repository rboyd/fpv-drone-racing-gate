"""Slice the actual 24-inch paper demonstration frame and fit plates using resolved local A1 Mini presets."""
from pathlib import Path
import json, subprocess, concurrent.futures
ROOT=Path(__file__).resolve().parents[1]; O=ROOT/'output/full_width_demo'
...
settings['process'].update(enable_support='0',brim_type='no_brim',print_sequence='by layer',wall_loops='3',sparse_infill_density='15%',curr_bed_type='Textured PEI Plate')
